            ...
            switch (ev.type) {
                ...
                case "touchmove":
                    if (touchStart === true) {
                        ...
                        var percent =
                            ((100 / pane_width) * deltaX) / pane_count;
                        ...
                        var opa =
                            Math.abs(deltaX) / $that.settings.threshold / 100 +
                            0.2;
                        if (opa > 1.0) {
                            opa = 1.0;
                        }
                        if (posX >= 0) {
                            panes
                                .eq(current_pane)
                                .find($that.settings.likeSelector)
                                .css("opacity", opa);
                            panes
                                .eq(current_pane)
                                .find($that.settings.dislikeSelector)
                                .css("opacity", 0);
                        } else if (posX < 0) {
                            panes
                                .eq(current_pane)
                ...
                case "touchend":
                    ...
                    posY = deltaY + lastPosY;
                    var opa = Math.abs(
                        Math.abs(deltaX) / $that.settings.threshold / 100 + 0.2
                    );
                        ...
                        if (posX > 0) {
                            panes
                                ...
                                .animate(
                                    ...
                                    function() {
                                        if ($that.settings.onLike) {
                                            $that.settings.onLike(
                                                panes.eq(current_pane)
                                            );
                                        }
                                        $that.next();
                                    }
